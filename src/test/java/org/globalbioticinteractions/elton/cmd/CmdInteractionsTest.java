...
public class CmdInteractionsTest {
    ...
    public void interactionsWithHeader() throws URISyntaxException {
        ...
        if (actual.getObjects().get(0) instanceof Runnable) {
            ...
            assertThat(lines[0], is("sourceOccurrenceId\tsourceTaxonId\tsourceTaxonName\tsourceTaxonRank\tsourceTaxonPath\tsourceTaxonPathIds\tsourceTaxonPathNames\tsourceBodyPartId\tsourceBodyPartName\tsourceLifeStageId\tsourceLifeStageName\tinteractionTypeId\tinteractionTypeName\ttargetOccurrenceId\ttargetTaxonId\ttargetTaxonName\ttargetTaxonRank\ttargetTaxonPath\ttargetTaxonPathIds\ttargetTaxonPathNames\ttargetBodyPartId\ttargetBodyPartName\ttargetLifeStageId\ttargetLifeStageName\tbasisOfRecordId\tbasisOfRecordName\thttp://rs.tdwg.org/dwc/terms/eventDate\tdecimalLatitude\tdecimalLongitude\tlocalityId\tlocalityName\treferenceDoi\treferenceUrl\treferenceCitation\tnamespace\tcitation\tarchiveURI\tlastSeenAt\tcontentHash\teltonVersion"));
