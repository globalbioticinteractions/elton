...
public class CmdInteractionsTest {
    ...
    public void interactions() throws URISyntaxException {
        ...
        if (actual.getObjects().get(0) instanceof Runnable) {
            ...
            assertThat(out1.toString(), startsWith("Leptoconchus incycloseris\t\t\t\t\t\thttp://purl.obolibrary.org/obo/RO_0002444\tparasiteOf\tFungia (Cycloseris) costulata\t\t\t\t\t\tglobalbioticinteractions/template-dataset\thttps://zenodo.org/record/207958/files/globalbioticinteractions/template-dataset-0.0.2.zip\t\t631d3777cf83e1abea848b59a6589c470cf0c7d0fd99682c4c104481ad9a543f\tdev\n"));
        }
    }
