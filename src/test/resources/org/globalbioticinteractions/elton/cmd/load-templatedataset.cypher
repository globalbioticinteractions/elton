...
LOAD CSV WITH HEADERS FROM 'https://depot.globalbioticinteractions.org/reviews/globalbioticinteractions/template-dataset/indexed-names-resolved-col.csv.gz' AS row
CALL (row) {
